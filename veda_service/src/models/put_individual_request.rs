...
pub struct PutIndividualRequest {
    /// The unique identifier of the user's ticket.
    #[serde(rename = "ticket")]
    pub ticket: String,
    /// The individual object to be updated or inserted.
    #[serde(rename = "individual")]
    pub individual: serde_json::Value,
...
impl PutIndividualRequest {
    pub fn new(ticket: String, individual: serde_json::Value) -> PutIndividualRequest {
        PutIndividualRequest {
            ticket,
            individual,
            prepare_events: None,
