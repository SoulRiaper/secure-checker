...
pub struct AddFieldToIndividualRequest {
    ...
    #[serde(rename = "uri")]
    pub uri: String,
    /// An object representing the individual with the field to be added.
...
impl AddFieldToIndividualRequest {
    pub fn new(ticket: String, uri: String) -> AddFieldToIndividualRequest {
