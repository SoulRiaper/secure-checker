...
pub struct PutMultipleIndividualsRequest {
    /// The unique identifier of the user's ticket.
    #[serde(rename = "ticket")]
    pub ticket: String,
    /// An array of individual objects to be updated or inserted.
    #[serde(rename = "individuals")]
    pub individuals: Vec<serde_json::Value>,
...
impl PutMultipleIndividualsRequest {
    pub fn new(ticket: String, individuals: Vec<serde_json::Value>) -> PutMultipleIndividualsRequest {
