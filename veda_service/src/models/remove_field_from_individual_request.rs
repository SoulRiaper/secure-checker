...
pub struct RemoveFieldFromIndividualRequest {
    ...
    #[serde(rename = "uri")]
    pub uri: String,
    /// An object representing the individual with the field to be removed.
...
impl RemoveFieldFromIndividualRequest {
    pub fn new(ticket: String, uri: String) -> RemoveFieldFromIndividualRequest {
